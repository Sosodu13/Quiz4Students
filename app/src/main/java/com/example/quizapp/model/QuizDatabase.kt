...
abstract class QuizDatabase: RoomDatabase() {
    ...
    fun seed() {
        ...
        if (questiondao().countQuestion() == 0){

            val themeDao = themedao()
            val theme1 = Theme(1, "code")
            val theme2 = Theme(2, "digital")
            val theme3 = Theme(3, "site web")
            val theme4 = Theme(4, "informatique")
            val theme5 = Theme(5, "automatisation")
            val theme6 = Theme(6, "entreprise")
            val theme7 = Theme(7, "technologie")
            val theme8 = Theme(8, "droit")
            themeDao.insertAll(
                theme1,
                theme2,
                theme3,
            ...
            val response1Q3 = Response(11,  "Passer d'une logique matérielle à une logique de service. Le but étant de limiter ses investissements tout en se laissant la possibilité d'évoluer facilement en termes de capacité", true, 3)
            ...
            val response1Q4 = Response(16,  "Cela permet de capter facilement des clients potentiels. Si l’on n’apparaît pas sur la première page de Google, on est hors jeu.", true, 4)
            ...
            val response1Q5 = Response(21,  "Oui. Mais attention, chaque réseau social a ses codes, certains contenus peuvent être communs, d’autres doivent être retravaillés", true, 5)
            ...
            val response4Q5 = Response(24,  "Non, il vaut mieux poster les photos sur Instagram, les vidéos sur YouTube et TikTok et les articles sur LinkedIn", false, 5)
            val response5Q5 = Response(25,  "Je ne sais pas", false, 5)
            val response1Q6 = Response(26,  "Cela dépend. Il existe des sites qui recensent les horaires et les jours statistiquement favorables, réseau social par réseau social", true, 6)
            ...
            val response1Q7 = Response(31,  "Hugo doit faire très attention s'il a reçu un mail qui semble envoyé par son directeur. Il doit le supprimer sans cliquer sur le lien hypertexte qui renvoie vers un faux site afin d’obtenir des données confidentielles", true, 7)
            ...
            val response1Q8 = Response(36,  "Les données doivent être lues uniquement par des personnes habilitées et aucune copie illicite ne doit pouvoir être réalisée", true, 8)
            ...
            val response1Q9 = Response(41,  "Jamais. Elle doit toujours être vigilante quand elle utilise des ordinateurs publics ou partagés. En effet, elle doit protéger ses mots de passe et ne pas oublier de bien se déconnecter de tous ses comptes personnels", true, 9)
            ...
            val response1Q10 = Response(46,  "Un robot logiciel pouvant dialoguer avec le consommateur en imitant les conversations humaines, à partir d'algorithmes de Machine Learning (ML) et de reconnaissance du langage naturel (NLP).", true, 10)
            ...
            val response1Q11 = Response(51,  "Les 3 réponses", true, 11)
            ...
            val response1Q12 = Response(56,  "Le programme est capable de s'adapter à son environnement et donc de modifier sa réponse en fonction d'éléments qui n'ont pas été spécifiquement indiqués dans le code", true, 12)
            ...
            val response1Q13 = Response(61,  "Les tableaux de bord permettent de mettre en lien les données et de simplifier leur lecture. Chaque directeur peut ainsi s'appuyer sur des jeux de données pertinents pour piloter son activité", true, 13)
            ...
            val response1Q14 = Response(66,  "Prendre des décisions à partir des données permet de rentrer dans une stratégie basée sur les faits. Ainsi, on n'utilise pas les données pour confirmer ses intuitions mais pour diriger ses actions", true, 14)
            ...
            val response1Q15 = Response(71,  "La plupart des entreprises n'analysent pas leurs données en temps réel. Les données sont donc copiées (souvent le soir) vers un datawarehouse, sorte de grosse base de données où on les lie entre elles et les prépare pour être ensuite plus facilement lues", true, 15)
            ...
            val response1Q16 = Response(76,  "Vrai, une entreprise 2.0 utilise un site, un intranet et les réseaux sociaux, une entreprise 3.0 s'appuie sur le tout-automatisation et de la robotique et la 4.0, celle du digital, le big data / l’analytique et l'intelligence artificielle", true, 16)
            ...
            val response1Q17 = Response(81,  "Modéliser un bâtiment afin d'en créer une version virtuelle. Cela permet ainsi de faciliter les simulations, la construction et la maintenance.   Le BIM signifie Building Information Modeling", true, 17)
            ...
            val response1Q18 = Response(86,  "Analyser le besoin réel et s'interroger sur : 'par quoi remplacer l'intervention humaine'. Cela peut conduire à des solutions hybrides, dans lesquelles on fait faire une partie des activités par des robots et on maintient une autre partie sous la responsabilité d'un humain", true, 18)
            ...
            val response1Q19 = Response(91,  "Ces sont des villes connectées qui utilisent l'intelligence artificielle et les nouvelles technologies pour améliorer le quotidien de ses habitants", true, 19)
            ...
            val response1Q20 = Response(96,  "Le V-commerce (virtual commerce) correspond à l’utilisation des technologies immersives pour vendre des produits et des services", true, 20)
            ...
            val response1Q21 = Response(101,  "Les 3 propositions sont vraies", true, 21)
            ...
            val response1Q22 = Response(106,  "Oui, il repose sur le partage des biens, services ou espaces", true, 22)
            ...
            val response1Q23 = Response(111,  "La santé représente des milliard d'euros et travailler en prévention permettrait d'allonger la vie et de réduire les soins curatifs", true, 23)
            ...
            val response1Q24 = Response(116,  "Ce que les utilisateurs souhaitent, ce n’est pas forcément ce qu’il y a de mieux mais surtout quelque chose de simple", true, 24)
            ...
            val response1Q25 = Response(121,  "Les banques ont souvent peur de prêter à des entreprises innovantes et jeunes qui ne rentrent pas dans leurs cases habituelles. Le crowdfunding permet d'emprunter directement à des particuliers", true, 25)
            ...
            val response1Q26 = Response(126,  "La blockchain remplace le tiers de confiance par une validation informatique vérifiée par des centaines de milliers d'ordinateurs ainsi qu'un registre ouvert et transparent", true, 26)
            ...
            val response1Q27 = Response(131,  "Des milliers de pc se partagent le registre des transactions et si plus de la moitié est d'accord pour enregistrer cette transaction, alors elle est considérée comme légitime", true, 27)
            ...
            val response4Q27 = Response(134,  "Les demandes sont envoyées en fonction du contenu et de la disponibilité des 'grands validateurs' à un minimum de 15 grands validateurs qui, au fil des 'validations' gagnent en indice de confiance", false, 27)
            val response5Q27 = Response(135,  "Je ne sais pas", false, 27)
            val response1Q28 = Response(136,  "14 jours à compter de la réception de la machine", true, 28)
            ...
            val response1Q29 = Response(141,  "Les mentions légales (comme le RCS de l'entreprise ou les Conditions Générales de Vente)", true, 29)
            ...
            val response1Q30 = Response(146,  "Toutes ces réponses", true, 30)
            ...
            val conceptThemeDAO = concept_themedao()
            val concepttheme1 = ConceptTheme(1,1,1)
            val concepttheme2 = ConceptTheme(2,1,4)
            val concepttheme3 = ConceptTheme(3,10,2)
            val concepttheme4 = ConceptTheme(4,10,3)
            val concepttheme5 = ConceptTheme(5,9,3)
            val concepttheme6 = ConceptTheme(6,7,4)
            val concepttheme7 = ConceptTheme(7,7,5)
            val concepttheme8 = ConceptTheme(8,2,5)
            val concepttheme9 = ConceptTheme(9,5,6)
            val concepttheme10 = ConceptTheme(10,8,6)
            val concepttheme11 = ConceptTheme(11,8,7)
            val concepttheme12 = ConceptTheme(12,4,6)
            val concepttheme13 = ConceptTheme(13,6,7)
            val concepttheme14 = ConceptTheme(14,3,8)
            conceptThemeDAO.insertAll(
                concepttheme1,
                concepttheme2,
                concepttheme3,
                concepttheme4,
